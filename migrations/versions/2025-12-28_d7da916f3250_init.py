...
Revision ID: d7da916f3250
Revises:
Create Date: 2025-12-28 18:47:45.526366
...
def upgrade() -> None:
    ...
    sa.Column('is_active', sa.Boolean(), server_default=sa.text('1'), nullable=True, comment='Признак, писал ли пользователь боту'),
    ...
    sa.ForeignKeyConstraint(['event_id'], ['events.id'], ondelete='CASCADE', name="cancel_event_fkc"),
    sa.PrimaryKeyConstraint('id')
    )
